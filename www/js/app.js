...
(function(){//Use javasctipr Closures, Immediately Invoked Function Expression (IIFE) to prevent global conflicts
   ...
   .constant('CONSTANT',{"SITE_NAME":"Aurora benedictio"})
   .config(config)
   .run(run);
   ...
   run.$inject = ["$ionicPlatform","$location"];
   function run($ionicPlatform,$location) {
      ...
      $ionicPlatform.ready(function() {
         ...
         iyona.on("GRADE",ionic.Platform.grade,ionic.Platform.platforms,ionic.Platform.device() );
