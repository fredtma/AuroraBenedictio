...
function config($stateProvider,$urlRouterProvider,$httpProvider,$ionicConfigProvider,$compileProvider) {
   ...
   $stateProvider
      ...
      .state('call.article', {url: "/article/{jesua}/{field}/{search}",views: {'principle': {templateUrl: 'cera/mensa/article-logs.html',controller: 'ArticleLogsCtrl',onExit:['$ionicSideMenuDelegate',function($ionicSideMenuDelegate){iyona.on('On Exit');$ionicSideMenuDelegate.canDragContent(true);}] }}/**/})
